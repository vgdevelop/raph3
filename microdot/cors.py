class CORS:
    ...
    def __init__(self, app=None, allowed_origins=None, allow_credentials=False,
        ...
        self.allowed_headers = None if allowed_headers is None \r
    ...
    def get_cors_headers(self, request):
        ...
        if self.allowed_origins == '*':
            ...
            cors_headers['Vary'] = 'Origin'
        if self.allow_credentials and \r
                'Access-Control-Allow-Origin' in cors_headers:
            cors_headers['Access-Control-Allow-Credentials'] = 'true'
        if self.expose_headers:
            cors_headers['Access-Control-Expose-Headers'] = \r
        ...
        if request.method == 'OPTIONS':
            ...
            if method:
                method = method.upper()
                if self.allowed_methods is None or \r
            ...
            if headers:
                if self.allowed_headers is None:
                    ...
                    cors_headers['Access-Control-Allow-Headers'] = \r
                        ', '.join(headers)
